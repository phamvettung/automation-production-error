# PHÂN LOẠI SẢN PHẨM LỖI DỰA TRÊN HÌNH ẢNH TRONG DÂY CHUYỀN TỰ ĐỘNG
...
***2. Support Vector Machines với đặc trưng HOG (Histogram of Oriented Gradients) và Phương pháp lựa chọn mô hình sử dụng chiến lược Holdout.***
